# Generated by Django 4.2.5 on 2023-10-05 22:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('высокий', 'Высокий'), ('средний', 'Средний'), ('не горит', 'Не горит')], max_length=20)),
                ('status', models.CharField(choices=[('выполнен', 'Выполнен'), ('в работе', 'В работе'), ('простаивает', 'Простаивает')], max_length=20)),
